...
import { IAccount, IAddress, IChangePassword, IChangeRSAkey, IMember, IProfile, ISearch } from "../interfaces/app.interface";
...
export class MemberService {
    ...
    async updateMemberItem(memberID: any, body: IAccount, accessToken: string) {
        ...
        try {
            ...
            const memberUpdateCount = await this.MemberCollection.count({ username: body.username });
